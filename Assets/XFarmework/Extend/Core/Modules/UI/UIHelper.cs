...
{
    public const string JumpToPanel = "JumpToPanel";    // 转场幕布
    ...
    /// 打开面板
    /// </summary>
    public void Open(string name, bool closeable = false, params object[] args)
    {
        m_UIManager.OpenPanel(name, closeable, args);
    }
